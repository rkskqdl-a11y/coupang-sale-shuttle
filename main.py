...
def generate_ai_content(item):
    ...
    # AI 실패 시 대체 문구 (300자 이상 보강)
    return f"<h3>🔍 전문가의 정밀 분석 보고서</h3>{short_name} 모델은 현재 {price}원의 가격대에서 만날 수 있는 최상의 기술력이 집약된 모델입니다. 세련된 디자인과 탄탄한 기본기, 그리고 사용자를 배려한 세심한 설계가 돋보입니다. 실제 환경에서의 안정적인 퍼포먼스는 물론, 공간의 가치를 높여주는 미학적 완성도까지 갖추고 있어 해당 카테고리 내에서 독보적인 가치를 제공할 것으로 분석됩니다."
